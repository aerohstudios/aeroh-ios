...
struct SignupController {
    func authenticate(first_name: String, email: String, password: String, errorCallback: @escaping (String) -> Void, successCallback: @escaping () -> Void) {
        let scopes = "mobile"
        ...
        APIManager.shared.callingSignupAPI(userRequestData: userRequestData, errorCallback: { errorMessage in
